...
The main portfolio website (`Sanya's portfolio/`) serves as a comprehensive showcase of my journey as a Software Engineering Technology student at Centennial College, specializing in Artificial Intelligence. The site features a modern design with smooth animations, responsive layouts, and interactive elements.
...
- **Location**: `/Project 1/`
- **Description**: Interactive web application for generating multiplication tables with customizable parameters
...
- **Demo**: [View Demo](./Project%201/project1.html)

### Project 2: Bug Smasher Game
- **Location**: `/Project 2/`
- **Description**: jQuery-based interactive bug smashing game with score tracking and timer
...
- **Features**:
  ...
  - Game rules modal
  - Speed adjustments
- **Demo**: [View Demo](./Project%202/project2.html)

## 🔧 How to Run Projects

### Portfolio Website
1. Navigate to `Sanya's portfolio/` directory
2. Run `npm install` to install dependencies
3. Run `npm run dev` to start development server
4. Open http://localhost:5173 in your browser

### Standalone Projects
1. Navigate to the respective project directory (`Project 1/` or `Project 2/`)
2. Open the HTML file directly in a web browser
3. Enjoy the interactive applications!
...
- **LinkedIn**: [Sanya Bansal](https://www.linkedin.com/in/sanya-bansal-824830302/)
- **GitHub**: [Sanyabansal115](https://github.com/Sanyabansal115)
- **Portfolio Website**: [https://sanya-s-portfolio.vercel.app](https://sanya-s-portfolio.vercel.app)
- **Location**: Toronto, Ontario, Canada

---

**Built with ❤️ by Sanya Bansal** - Software Engineering Technology Student specializing in AI
