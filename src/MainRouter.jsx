...
import SignIn from './components/SignIn';          // User authentication (login)
import SignUp from './components/SignUp';          // User registration
import AdminDashboard from './components/AdminDashboard'; // Admin dashboard
import { AdminRoute } from './components/ProtectedRoute';  // Route protection
