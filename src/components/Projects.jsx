...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Interactive web application for generating multiplication tables with customizable parameters. Built with HTML, CSS, and JavaScript featuring responsive design, user input validation, and dynamic table generation. Allows users to specify table dimensions and automatically calculates results.",
      icon: "🔢",
      tags: ["HTML", "CSS", "JavaScript", "Interactive", "Math Tool"],
      type: "webdev",
      demoLink: "/projects/web_development/Project 1/project1.html",
      codeLinks: {
        html: "/projects/web_development/Project 1/project1.html",
        css: "/projects/web_development/Project 1/project1.css", 
        js: "/projects/web_development/Project 1/project1.js"
      },
      githubLink: "https://github.com/Sanyabansal115/Web-Development-Projects",
    },
    {
      id: 7,
      title: "Bug Smasher Game",
      description:
        "Interactive jQuery-based bug smashing game with score tracking, timer functionality, and progressive difficulty levels. Features dynamic bug spawning, collision detection, smooth animations, and responsive controls. Includes game rules modal, speed adjustments, and score reset functionality.",
      icon: "🐛",
      tags: ["jQuery", "Game Development", "CSS Animation", "Interactive", "Timer"],
      type: "webdev",
      demoLink: "/projects/web_development/Project 2/project2.html",
      codeLinks: {
        html: "/projects/web_development/Project 2/project2.html",
        css: "/projects/web_development/Project 2/project2.css",
        js: "/projects/web_development/Project 2/project2.js"
      },
      githubLink: "https://github.com/Sanyabansal115/Web-Development-Projects",
    },
    {
